...
echo "Running Command : java -cp ${HADOOP_HIVE_JARS}:${HADOOP_CONF_DIR}:$HUDI_HIVE_SYNC_BUNDLE org.apache.hudi.hive.HiveSyncTool $@"
java -cp $HUDI_HIVE_SYNC_BUNDLE:${HADOOP_HIVE_JARS}:${HADOOP_CONF_DIR} org.apache.hudi.hive.HiveSyncTool "$@"